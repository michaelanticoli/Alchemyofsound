...
export default function Strategy() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm tracking-wide">
            ...
            <a href="#fit" className="text-muted-foreground hover:text-foreground transition-colors">Alignment</a>
      ...
      <section id="strategy" className="py-32 px-6 lg:px-12 max-w-7xl mx-auto">
        <motion.div
      ...
      <section id="experience" className="py-16 px-6 lg:px-12 max-w-7xl mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
      ...
      <section id="fit" className="py-24 px-6 lg:px-12 max-w-7xl mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
      ...
      <section id="contact" className="py-24 px-6 lg:px-12 max-w-7xl mx-auto text-center">
        <motion.h2
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
